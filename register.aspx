<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="FinalCode.register" %>
			...
			<div class="row">
				...
				<div class="col-lg-6">
						...
						<input type="text" placeholder="Enter your name" runat="server" 
                               ...
                               <input type="text" readonly="readonly" placeholder="Username" runat="server" id="uname" />
					     <input type="text"  placeholder="Email" runat="server" id="mailid" />
                              ...
                              <input type="text" placeholder="Enter your age" runat="server" 
                                ...
                                <input type="text" placeholder="Enter your cet" runat="server" 
                                id="cet" />

                              <input type="text" placeholder="Enter your area" runat="server" 
                                id="addr" />
				...
				<div class="reg">
                      <input type="reset"  id="reset" runat="server" onserverclick="Reset"  value="reset" />
		<input type="submit"  id="submit" runat="server" value="submit" onclick="return validateForm();"  onserverclick="Submit" />
   	...
   	<script>
   	    function validateForm() {
   	        ...
   	        if (!exp.test(x)) {
   	            ...
   	            alert("phone number must be filled out start wiyh 6,7,8,9");
   	            return false;
   	        }
