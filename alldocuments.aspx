<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alldocuments.aspx.cs" Inherits="FinalCode.alldocuments" %>
  ...
  <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" CssClass="table table-responsive" CellPadding="3" EmptyDataText="No Data" 
      ...
      <Columns>
                        <asp:BoundField DataField="Docid" HeaderText="Document Id" 
                            ...
                            <asp:BoundField DataField="named" HeaderText="Uploaded By" 
