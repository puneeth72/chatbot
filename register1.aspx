<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register1.aspx.cs" Inherits="FinalCode.register1" %>
...
<body>
  ...
  <input type="text" placeholder="Enter the Registername" runat="server" id="uname" name="uname" />
