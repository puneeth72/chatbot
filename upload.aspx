<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upload.aspx.cs" Inherits="FinalCode.upload" %>
            ...
            <span class="icon-bar"></span>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<div class="nav_right_top">
								...
								<li>
								<a class="scroll" href="userhome.aspx">Home</a>
							</li>
                             <li class="active">    
            ...
            <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
				...
				<table class="style1" style="color:black;font-size:18px;font-weight:bold;" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;
                            <asp:FileUpload ID="EPFileUpload1" runat="server" />
                        </td>
                         <td>
                    ...
                    <tr>
                        ...
                        <td class="style2">
                            ...
                            <asp:FileUpload ID="SMFileUpload1" runat="server" />
                        </td>
                         <td>
					 ...
					 <tr>
                       <td style="font-size:18px;">
                        ...
                        <td>&nbsp;
                            ...
                            <asp:FileUpload ID="PMFileUpload1" runat="server" />
                            </td>
                        <td align="right">
                          </td>
                        <td>
                     ...
                     <tr>
                       <td>
                        ...
                        <td>
                            ...
                            <asp:FileUpload ID="APFileUpload1" runat="server" />
                        </td>
                        <td align="right">
                           </td>
                        <td>
